...
```java
- /tmp/git-projects/edff5e85-8c53-4b5e-9c5c-a04422cb6997
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobPedt003Builder.java**: Indicates the sources and targets the generated application
